...
class HomeView: UIViewController {
    ...
    private func setupUI(){
        ...
        markButton.backgroundColor = #colorLiteral(red: 0.2174585164, green: 0.8184141517, blue: 0, alpha: 1)
        ...
        markButton.layer.borderColor = #colorLiteral(red: 0.2174585164, green: 0.8184141517, blue: 0, alpha: 0.2913099315)
    ...
    func colorButton(isActive: Bool){
        let backGroundColor = isActive == true ? #colorLiteral(red: 1, green: 0.1491314173, blue: 0, alpha: 1) : #colorLiteral(red: 0.2174585164, green: 0.8184141517, blue: 0, alpha: 1)
